...
export default function Paging({ page, setPage, pageLimit = 2 }: Props) {
    ...
    const getPageNumberCSS = (pageNumber: number) => {
        ...
        return "relative hidden items-center px-4 py-2 text-sm font-semibold text-gray-900 ring-1 ring-gray-300 ring-inset hover:bg-gray-50 focus:z-20 focus:outline-offset-0 md:inline-flex";
    }
    ...
    const pageNumberDisplay = () => {
        ...
        return arr.map(num => <a className={getPageNumberCSS(num)}>{num}</a>)
    }
