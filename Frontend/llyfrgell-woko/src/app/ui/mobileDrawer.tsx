    ...
    >
      ...
      <ul className="flex flex-col justify-center items-center space-y-4">
        <li className="text-xl hover:text-blue-900 hover:font-semibold">
          <Link href="/">
            <button type="button" className="w-44 flex justify-center items-center text-white bg-gradient-to-r from-black to-gray-400 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm p-1 p-3">
        ...
        <li className="text-xl hover:text-blue-900 hover:font-semibold">
          <Link href="/books">
            <button type="button" className="w-44 flex justify-center flex items-center text-white bg-gradient-to-r from-black to-gray-400 hover:bg-gradient-to-l focus:ring-4 focus:outline-none focus:ring-purple-200 dark:focus:ring-purple-800 font-medium rounded-lg text-sm p-1 p-3">
